...
import (
	...
	arnabbaishnabcomv1alpha1 "github.com/arnab-baishnab/sample-controller/pkg/apis/arnabbaishnab.com/v1alpha1"
	versioned "github.com/arnab-baishnab/sample-controller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/arnab-baishnab/sample-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/arnab-baishnab/sample-controller/pkg/generated/listers/arnabbaishnab.com/v1alpha1"
...
func NewFilteredKlusterInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&arnabbaishnabcomv1alpha1.Kluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *klusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&arnabbaishnabcomv1alpha1.Kluster{}, f.defaultInformer)
}
